...
- [x] R-021: окно отмены через API (`cancellation_window_minutes`, дефолт 120 мин)
- [x] **Проверка студентом:** порог отмены — дефолт 120 мин до согласования с «Мариной» (2026-07-04)
